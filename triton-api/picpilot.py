...
from image2video_serve import Image2VideoAPI
...
if __name__=="__main__":
    ...
    image2video_server = LitServer(Image2VideoAPI(),api='/api/v2/image2video/cogvideox',accelerator='auto',max_batch_size=1,batch_timeout=0.1)
